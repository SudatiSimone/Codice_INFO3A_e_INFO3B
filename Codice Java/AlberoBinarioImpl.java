...
public class AlberoBinarioImpl implements AlberoBinario{
    ...
    public int altezza() {
    	NodoBinario start=this.radice();
    	if (start==null) return 0;
    	if (start.destro==null && start.sinistro==null)return 1;
    	
    	return 1+Math.max(this.pota(start.destro).altezza(),this.pota(start.sinistro).altezza());
    }
